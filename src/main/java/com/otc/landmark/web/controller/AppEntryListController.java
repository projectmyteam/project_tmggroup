...
public class AppEntryListController {
	...
	public ModelAndView entryListGet(@RequestParam(value = "categoryId") Long categoryId) {
		...
		try {
			...
			PageWrapperDto<EntryDto> pageWrapperDto = entryService.search(CommonConst.DEFAULT_PAGE, CommonConst.DEFAULT_PAGESIZE, entryDto);			
	...
	public ModelAndView entryListPost(@RequestParam(value = "categoryId") Long categoryId, @RequestParam(value = "page") int page,
		...
		try {
			...
			EntryDto entryDto = new EntryDto();
			entryDto.setSubCategoryId(categoryId);
			PageWrapperDto<EntryDto> pageWrapperDto = entryService.search(page, pageSize, entryDto);
